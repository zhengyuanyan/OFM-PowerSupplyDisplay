...
#define ModuleVersion_ModuleName "PowerSupplyDisplay"
#define ModuleVersion_knxprod_h DSP_ModuleVersion
#define ModuleVersion_version_h MODULE_PowerSupplyDisplay_ETS
